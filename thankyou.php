...
<html lang="en">
    ...
    <body>
        ...
        <div class="mx-auto">
        <center><img src="completed.png" class="img-fluid text-center" alt="responsive image" id="timesup" style="height: 500px; width: auto; ; "></center><br> <br>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12 segment-one md-mb-30 sm-mb-30">
                            <div style="float: left;">
                              <img src="GEARFINAL.png" alt="" width="60" height="60" title="ISTE">
